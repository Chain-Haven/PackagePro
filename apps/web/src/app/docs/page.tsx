...
export const metadata = {
  ...
  description:
    'Documentation for onboarding, desktop setup, WooCommerce pairing, ShipStation, and security.',
};
    ...
    <div className="min-h-screen bg-muted/30 px-6 py-16">
      <div className="mx-auto max-w-5xl">
        ...
        <h1 className="mt-3 text-4xl font-extrabold tracking-tight">
          Guides for every PackagePro surface
        </h1>
        <p className="mt-4 max-w-2xl text-base text-muted-foreground">
          Start with onboarding, then move into store pairing, station setup, ShipStation mapping,
